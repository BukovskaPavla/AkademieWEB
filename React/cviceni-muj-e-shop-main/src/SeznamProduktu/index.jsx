...
const SeznamProduktu = ({pridatPolozku, odebratPolozkku}) => {
    return (
        <div className="seznam-produktu">
            {
                produkty.map(produkt => <Produkt key={produkt.id} pridatPolozku={pridatPolozku} odebratPolozkku={odebratPolozkku}{...produkt}/>)
            }
        </div>
    )
}
